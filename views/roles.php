            ...
            <table class="table table-striped table-hover" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge <?php echo $rol['estado'] === 'Activo' ? 'badge-success' : 'badge-danger'; ?>">
                                <?php echo htmlspecialchars($rol['estado']); ?>
                            </span>
                        </td>
                        <td>
                            <button type="button" class="btn btn-success edit-role" 
                            ...
                            <button type="button" class="btn <?php echo $rol['estado'] === 'Activo' ? 'btn-warning' : 'btn-info'; ?> toggle-status" 
                                    data-id="<?php echo $rol['id']; ?>"
                                    data-nombre="<?php echo htmlspecialchars($rol['rol_nombre']); ?>"
                                    data-estado="<?php echo htmlspecialchars($rol['estado']); ?>">
