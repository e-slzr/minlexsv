...
<div class="barra_superior">
    ...
    <div class="link_login">
        <?php
        $nombre = $_SESSION['user']['nombre_completo'] ?? 'Usuario';
...
<nav id="menuLateral" class="menu-lateral">
    <ul class="list-group">
        ...
        <ul id="subMenuProduccion" class="collapse list-group">
            <a href="../views/po.php"><li>PO (Purchase Orders)</li></a>
            <a href="../views/ordenes_produccion.php"><li>Ordenes de producción</li></a>
        </ul>
        ...
        <ul id="subMenuAlmacen" class="collapse list-group">
            <a href="../views/bodegas.php"><li>Bodegas</li></a>
        </ul>
        ...
        <ul id="subMenuReportes" class="collapse list-group">
            <a href="../views/reporte_calidad.php"><li>Reporte de Calidad</li></a>
            <a href="../views/reporte_corte.php"><li>Reporte de Corte</li></a>
            <a href="../views/reporte_costura.php"><li>Reporte de Costura</li></a>
            <a href="../views/reporte_produccion.php"><li>Reporte de Produccion</li></a>
        </ul>
        ...
        <ul id="subMenuAdmin" class="collapse list-group">
            <a href="../views/clientes.php"><li>Clientes</li></a>
            <a href="../views/usuarios.php"><li>Usuarios</li></a>
            <a href="../views/roles.php"><li>Roles</li></a>
        </ul>
        ...
        <ul id="subMenuAyuda" class="collapse list-group">
            <a href="../views/manual_usuario.php"><li>Manual de usuario</li></a>
            <a href="../views/recursos.php"><li>Recursos</li></a>
        </ul>
    </ul>
</nav>
