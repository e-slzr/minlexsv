        ...
        <ul class="list-group">
            ...
            <li>
                ...
                <ul id="subMenuProduccion" class="collapse list-group">
                    <a href="../views/po.php" class=""><li>PO (Purchase Orders)</li></a>
                    <a href="../views/ordenes_produccion.php" class=""><li>Ordenes de producción</li></a>
                </ul>
            ...
            <li>
                ...
                <ul id="subMenuAlmacen" class="collapse list-group">
                    <a href="../views/bodegas.php" class=""><li>Bodegas</li></a>
                </ul>
            ...
            <li>
                ...
                <ul id="subMenuReportes" class="collapse list-group">
                    <a href="../views/reporte_calidad.php" class=""><li>Reporte de Calidad</li></a>
                    <a href="../views/reporte_corte.php" class=""><li>Reporte de Corte</li></a>
                    <a href="../views/reporte_costura.php" class=""><li>Reporte de Costura</li></a>
                    <a href="../views/reporte_produccion.php" class=""><li>Reporte de Produccion</li></a>
                </ul>
            ...
            <li>
                ...
                <ul id="subMenuAdmin" class="collapse list-group">
                    <a href="../views/clientes.php" class=""><li>Clientes</li></a>
                    <a href="../views/usuarios.php" class=""><li>Usuarios</li></a>
                    <a href="../views/roles.php" class=""><li>Roles</li></a>
                </ul>
            ...
            <li>
                ...
                <ul id="subMenuAyuda" class="collapse list-group">
                    <a href="../views/manual_usuario.php" class=""><li>Manual de usuario</li></a>
                    <a href="../views/recursos.php" class=""><li>Recursos</li></a>
                </ul>
        </ul>
    </nav>
